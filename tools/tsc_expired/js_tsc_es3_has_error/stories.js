      ...
      pcGlobal.fillListAndPagination(
        ...
        function (itemElement, data, init) {
          if (init) {
            ...
            var summaryAndDateElement = itemElement.children[1];
            var summaryElement = summaryAndDateElement.children[0];
            var storyDateElement = summaryAndDateElement.children[1];
