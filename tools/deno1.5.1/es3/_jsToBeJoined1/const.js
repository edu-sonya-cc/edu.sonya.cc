...
const DOMAIN = __exp["DOMAIN"];
const FILENAME_POSTFIX = __exp["FILENAME_POSTFIX"];
const CURRENT_URL = __exp["CURRENT_URL"];
const HOME_URL = __exp["HOME_URL"];
const HOME_URL_LENGTH = __exp["HOME_URL_LENGTH"];
const ACTUAL_PAGE_NAME_ARRAY = __exp["ACTUAL_PAGE_NAME_ARRAY"];
const getActualPageName = __exp["getActualPageName"];
const getActualPageValueByName = __exp["getActualPageValueByName"];
const PARAMETER_FOR_ACTUAL_PAGE = __exp["PARAMETER_FOR_ACTUAL_PAGE"];
const ACTUAL_PAGE_VALUE = __exp["ACTUAL_PAGE_VALUE"];
const ACTUAL_PAGE_NAME = __exp["ACTUAL_PAGE_NAME"];
const SITE_ROOT = __exp["SITE_ROOT"];
const SITE_IMAGE_PATH = __exp["SITE_IMAGE_PATH"];
const SITE_JAVASCRIPT_PATH = __exp["SITE_JAVASCRIPT_PATH"];
const SITE_CSS_PATH = __exp["SITE_CSS_PATH"];
const getPageParameterByName = __exp["getPageParameterByName"];
const PAGE_SUB_KIND = __exp["PAGE_SUB_KIND"];
const PAGE_IDNEX = __exp["PAGE_IDNEX"];
const PAGE_ID = __exp["PAGE_ID"];
const MORE_BUTTON_HTML = __exp["MORE_BUTTON_HTML"];
const BRICK_SUB_KINDS = __exp["BRICK_SUB_KINDS"];
const ACTIVATED_PROPERTY = __exp["ACTIVATED_PROPERTY"];
const SUB_KIND_NAME_PROPERTY = __exp["SUB_KIND_NAME_PROPERTY"];
const LANG_PROPERTY = __exp["LANG_PROPERTY"];
const PAGE_PROPERTY = __exp["PAGE_PROPERTY"];
const DEVICE_PROPERTY = __exp["DEVICE_PROPERTY"];
const REPORT_PROPERTY = __exp["REPORT_PROPERTY"];
const ID_PROPERTY = __exp["ID_PROPERTY"];
const PAPER_SIZE_PROPERTY = __exp["PAPER_SIZE_PROPERTY"];
const REPORT_KIND_PROPERTY = __exp["REPORT_KIND_PROPERTY"];