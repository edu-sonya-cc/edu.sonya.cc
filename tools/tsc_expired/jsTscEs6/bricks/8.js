...
class BrickCore extends PokerBase {
  constructor() {
    ...
    this.onPageSizeChanged = (_newPageSize) => {};
  ...
  <p><b edu-color="1">☺</b><b edu-color="2">3</b><b edu-color="3">3</b></p>
     ...
     */
    this.CENTER_NORMAL_CARD_TIMES = 2;
    /**
     * <en>Count of changeable cardcenter</en>
     * <zh_cn>百变牌数：中心</zh_cn>
     * <zh_tw>百变牌數：中心</zh_tw>
     */
    this.CENTER_CHANGEABLE_CARD_COUNT = 2;
    /**
    ...
    this.initOtherElements = () => {
      ...
      (_a = this.configCoreElement) === null || _a === void 0
        ? void 0
    ...
    this.initIncludeZeroElements = (wrapElement) => {
      ...
      [true, false].forEach((includeZeroValue) => {
    ...
    this.initWholePageElements = (wrapElement) => {
      ...
      [true, false].forEach((wholePageValue) => {
        const radioElement = createElement("input");
        radioElement.type = "radio";
    ...
    this.DECOR_COUNT = 4;
    this.NORMAL_CARD_ARRAY = getNumbersArray(1, 13);
    // https://zhuanlan.zhihu.com/p/76597144
    this.CHANGEABLE_CARD_ARRAY = [
      "☺",
    ...
    this.countIt = (
      ...
      for (
        ...
        for (let colorIndex = 1; colorIndex <= DECOR_COUNT; ++colorIndex) {
          ...
          NORMAL_CARD_ARRAY.forEach((char) => {
            CHARS.push(char);
            CENTER_TEXTS.push(centerText);
            COLORS.push(color);
            this.computedData.isCenters.push(isCenters);
