...
class BrickPage extends ActualPageBase {
  constructor() {
    ...
    this.pageSummaryElement = createElement("div");
    this.mainContentElement = createElement("div");
    this.feedbackElement = createElement("div");
    ...
    this.downloadAreaElement = createElement("div");
    this.shareAreaElement = createElement("div");
    this.sponsorElement = createElement("img");
    this.wechatShareElement = createElement("img");
    this.previewIframe = createElement("iframe");
    this.previewRegionElement = createElement("div");
    this.configRegionElement = createElement("div");
    this.configCoreWrapElement = createElement("div");
    this.configCoreToolbarElement = createElement("div");
    this.appendConfigToolbar = (idPostfix, eventName, i18n) => {
    ...
    this.fileReaderElement = createElement("input");
    this.brickCorePageInited = false;
    this.reporterPageInited = false;
    this.loadScript = (PAGE_NAME) => {
