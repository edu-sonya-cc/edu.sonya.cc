 ...
 * <zh_tw>網站域名</zh_tw>
 */
export var DOMAIN = "edu.sonya.cc";
/**
 * <en>Postfix of file name</en>
 * <zh_cn>文件名前綴</zh_cn>
 * <zh_tw>文件名前綴</zh_tw>
 */
export var FILENAME_POSTFIX = DOMAIN.concat("_");
/**
 * <en>Current URL</en>
 * <zh_cn>当前网址</zh_cn>
 * <zh_tw>當前網址</zh_tw>
 */
export var CURRENT_URL = window.location.href;
/**
 * <en>Home URL</en>
 * <zh_cn>首页网址</zh_cn>
 * <zh_tw>首頁網址</zh_tw>
 */
export var HOME_URL = CURRENT_URL.startsWith("file:///")
 ...
 * <zh_tw>首頁網址長度</zh_tw>
 */
export var HOME_URL_LENGTH = HOME_URL.length;
/**
 ...
 */
export var ACTUAL_PAGE_NAME_ARRAY = [
  "home",
  "bricks",
  "brick",
  "treasures",
 ...
 */
export var getActualPageName = function (value) {
...
*/
export var getActualPageValueByName = function (name) {
 ...
 * <zh_tw>當前實際頁面名</zh_tw>
 */
export var ACTUAL_PAGE_NAME = ACTUAL_PAGE_NAME_ARRAY[ACTUAL_PAGE_VALUE];
/**
 * <en>Site Root</en>
 * <zh_cn>网站根目录</zh_cn>
 * <zh_tw>網站根目錄</zh_tw>
 */
export var SITE_ROOT = HOME_URL.substring(0, HOME_URL.lastIndexOf("/") + 1);
/**
 * <en>Website image directory</en>
 * <zh_cn>网站图片目录</zh_cn>
 * <zh_tw>網站圖片目錄</zh_tw>
 */
export var SITE_IMAGE_PATH = "".concat(SITE_ROOT, "images/");
/**
 * <en>Site Script Directory</en>
 * <zh_cn>网站脚本目录</zh_cn>
 * <zh_tw>網站腳本目錄</zh_tw>
 */
export var SITE_JAVASCRIPT_PATH = "".concat(SITE_ROOT, "js/");
/**
 * <en>Site Style Sheet Directory</en>
 * <zh_cn>网站样式表目录</zh_cn>
 * <zh_tw>網站樣式表目錄</zh_tw>
 */
export var SITE_CSS_PATH = "".concat(SITE_ROOT, "css/");
/**
 ...
 * <zh_tw>參數值</zh_tw>
 */
export var getPageParameterByName = function (name, defaultValue) {
 ...
 * <zh_tw>頁面子類型</zh_tw>
 */
export var PAGE_SUB_KIND = getPageParameterByName("kind", null);
/**
 * <en>Page Index</en>
 * <zh_cn>页序</zh_cn>
 * <zh_tw>頁序</zh_tw>
 */
export var PAGE_IDNEX = parseInt(getPageParameterByName("page", "1"), 0) - 1;
/**
 * <en>Page parameter: No</en>
 * <zh_cn>页面参数：编号</zh_cn>
 * <zh_tw>頁面參數：編號</zh_tw>
 */
export var PAGE_ID = parseInt(getPageParameterByName("id", "1"), 0);
/**
 * <en>“查看更多”按钮文字</en>
 * <zh_cn>View more button text</zh_cn>
 * <zh_tw>“查看更多”按鈕文字</zh_tw>
 */
export var MORE_BUTTON_HTML =
