...
const hide = __exp["hide"];
const showBlock = __exp["showBlock"];
const showInlineBlock = __exp["showInlineBlock"];
const showFlex = __exp["showFlex"];
const showInlineFlex = __exp["showInlineFlex"];
const getElementById = __exp["getElementById"];
const getElementByIdAndTagName = __exp["getElementByIdAndTagName"];
const querySelectorAll = __exp["querySelectorAll"];
const querySelectorAllByI18n = __exp["querySelectorAllByI18n"];
const querySelectorAllByI18nPlaceholder = __exp["querySelectorAllByI18nPlaceholder"];
const getElementsByTagName = __exp["getElementsByTagName"];
const getHeadElement = __exp["getHeadElement"];
const getHtmlElement = __exp["getHtmlElement"];
const getBodyElement = __exp["getBodyElement"];
const getTitleElement = __exp["getTitleElement"];
const getHeaderElement = __exp["getHeaderElement"];
const getFooterElement = __exp["getFooterElement"];
const getMainElement = __exp["getMainElement"];
const createElement = __exp["createElement"];
const setAttributesOfA = __exp["setAttributesOfA"];
const stopEventBubble = __exp["stopEventBubble"];
const getI18nInnerHTML = __exp["getI18nInnerHTML"];
const getI18nInnerHTMLFromDate = __exp["getI18nInnerHTMLFromDate"];
const MONTH_NAME_ARRAY = __exp["MONTH_NAME_ARRAY"];
