...
declare class BrickCore extends BrickWithTableBase {
  ...
  /** OK
     ...
     * @returns 进位加的三个加数与和
     */
  private getMaybeCarryTwiceNumbers(has);
  ...
  private getHtmlOfAPlusB(A, B, result);
  private getSimleHtmlOfAMultiplyB;
  private isOnlyFirstIsNotZero;
  private getHtmlOfAMultiplyB(A, B, result);
  ...
  private getDebitHtml(A, B);
  private getDebitHtmlOfASubstractB(A, B, aSubstractB);
  ...
  /** OK
     ...
     * @param answerRowsArray
     */
  private countByArithmetic1(info, questionRowsArray, answerRowsArray);
  /** OK
     * A-B=C
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic2(info, questionRowsArray, answerRowsArray);
  /** OK
     * A+B=C D-E=F
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic3(info, questionRowsArray, answerRowsArray);
  /** OK
     * A+B+C=D
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic4(info, questionRowsArray, answerRowsArray);
  /**
     * A-B-C=D
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic5(info, questionRowsArray, answerRowsArray);
  /**
     * A±B±C=D
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic6(info, questionRowsArray, answerRowsArray);
  ...
  /**
     ...
     * @param answerRowsArray
     */
  private countByArithmetic7(info, questionRowsArray, answerRowsArray);
  /**
     * A×B±C=D
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic8(info, questionRowsArray, answerRowsArray);
  ...
  /**
     ...
     * @param answerRowsArray
     */
  private countByArithmetic9(info, questionRowsArray, answerRowsArray);
  /** OK
     * A×(B±C)=D
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic10(info, questionRowsArray, answerRowsArray);
  /** OK
     * A+B+C=10/20/n
     * @param info
     * @param questionRowsArray
     * @param answerRowsArray
     */
  private countByArithmetic11(info, questionRowsArray, answerRowsArray);
  /**
     ...
     * @param answerRowsArray
     */
  private countByArithmetic12(info, questionRowsArray, answerRowsArray);
  /**  */
  ...
  /** OK
     ...
     */
  protected createTableBodyRow: (item: any) => void;
  /** OK
     * 初始化表头
     */
  ...
  /** OK
     ...
     * @param buttonList
     */
  private addCommonItem(info, kindArray, buttonList);
  /** OK
     *
     * @param label
     * @param buttonList
     ...
     * @returns
     */
  private appendUsableItem(label, buttonList, usableList);
}
