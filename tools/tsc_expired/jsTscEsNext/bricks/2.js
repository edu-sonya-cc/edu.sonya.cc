  ...
  initPlusOrSubtractDictionaryNotGreatThan100Array = () => {
    for (let a = 0; a <= 100; ++a) {
      ...
      this.plusOrSubtractDictionaryNotGreatThan100Array.push({
        ...
        subtractorWithDebitMinusMaxIndex: subtractorWithDebitMinusArray.length -
          1,
...
p[edu-right-char="9"]{padding-right:9em;}
  ...
  getIndependentPaginationHtml = (
    ...
    rows.forEach((row) => {
      if (rowsOccupied > remainingRowCount) {
        html += `</page>${
          pageStartHtml.replace("~reporterPageIndex~", (++pageIndex).toString())
        }`;
  ...
  getSubtractorWithoutDebitMinus = (minuend) => {
    ...
    const array =
      plusOrSubtractDictionaryNotGreatThan100.subtractorWithoutDebitMinusArray;
  ...
  questionElementHtmlAppendOfAdditionWhenNotMentalArithmetic3 =
    '<div edu-flex="3"></div>';
  questionElementHtmlAppendOfAdditionWhenNotMentalArithmetic4 =
    '<div edu-flex="4"></div>';
  questionElementHtmlAppendOfAdditionWhenNotMentalArithmetic6 =
    '<div edu-flex="6"></div>';
  questionElementHtmlAppendOfSubstractionWhenNotMentalArithmetic8 =
  ...
  questionElementHtmlAppendOfSubstractionWhenNotMentalArithmetic4 =
  ...
  fillElementArrayOfASubtractBThenC = (
    has,
    questionElementHtmlAppend,
    onlyMentalArithmetic,
    questionElementArray,
  ...
  fillElementArrayOfASubtractBThenPlusC = (
    has,
    questionElementHtmlAppend,
    onlyMentalArithmetic,
    questionElementArray,
  ...
  fillElementArrayOfAPlusBThenSubtractC = (
    has,
    questionElementHtmlAppend,
    onlyMentalArithmetic,
    questionElementArray,
