...
var BoxBase = /** @class */ (function (_super) {
    ...
    function BoxBase() {
        ...
        _this.countDataAndComputedData = function () {
            ...
            var paperSize = data.paperSize, isLandscape = data.isLandscape, MAX_X = data.maxX, MAX_Y = data.maxY, pageMarginTop = data.pageMarginTop, 
            // pageMarginBottom,
            pageMarginLeft = data.pageMarginLeft, 
            // pageMarginRight,
            list = data.list, topWithoutHalfCircle = data.topWithoutHalfCircle;
