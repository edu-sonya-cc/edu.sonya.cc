...
var TreasuresPage = (function (_super) {
    ...
    function TreasuresPage() {
        ...
        _this.initMainElement = function () {
            ...
            pcGlobal.fillListAndPagination(listElement, paginationElement, PageSize.treasuresPage, treasures, PAGE_NAME, function (itemElement, data, init) {
                if (init) {
