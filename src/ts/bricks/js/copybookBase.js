...
var CopybookBase = /** @class */ (function (_super) {
    ...
    function CopybookBase(appendData, otherComputedData) {
        ...
        _this.countDataAndComputedData = function () {
            ...
            // const { CHARS } = this;
            var paperSize = data.paperSize, isLandscape = data.isLandscape, MAX_X = data.maxX, MAX_Y = data.maxY, pageMarginTop = data.pageMarginTop, pageMarginBottom = data.pageMarginBottom, pageMarginLeft = data.pageMarginLeft, pageMarginRight = data.pageMarginRight, 
            // copybooks,
        ...
        _this.updateCopybookData = function () {
            ...
            // pageMarginRight,
            copybooks = _b.copybooks, selectedCheckboxIndexArray = _b.selectedCheckboxIndexArray, kind = _b.kind, inputMethod = _b.inputMethod, fontSize = _b.fontSize, color = _b.color;
