...
var BrickCore = /** @class */ (function (_super) {
  ...
  function BrickCore() {
    ...
    _this.countPokerDataAndComputedData = function (pokerKind, countPerPage) {
      ...
      switch (pokerKind) {
        case EnglishLettersPokerKind.onlyLowerCase:
          backCover = "a-z<br /><br />".concat(getI18nInnerHTML({
            en: "English Letters",
            zh_cn: "英语小写字母",
            zh_tw: "英語小寫字母",
          }));
          title.en = "".concat(FILENAME_POSTFIX, "English Letters_a-z");
          title.zh_cn = "".concat(
            FILENAME_POSTFIX,
            "\u82F1\u8BED\u5C0F\u5199\u5B57\u6BCD_a-z",
          );
        ...
        case EnglishLettersPokerKind.onlyUpperCase:
          ...
          break;
        case EnglishLettersPokerKind.both:
          backCover = "a-z & A-Z<br /><br />".concat(getI18nInnerHTML({
            en: "English Letters",
            zh_cn: "英语字母<br />（大小写）",
            zh_tw: "英語字母<br />（大小寫）",
          }));
          title.en = "".concat(FILENAME_POSTFIX, "English Letters_a-z&A-Z");
          title.zh_cn = "".concat(
            FILENAME_POSTFIX,
            "\u82F1\u8BED\u5B57\u6BCD\uFF08\u5927\u5C0F\u5199\uFF09_a-z&A-Z",
          );
