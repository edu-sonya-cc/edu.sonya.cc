...
var BrickCore = (function (_super) {
    ...
    function BrickCore() {
        ...
        _this.getForePageHtml = function () {
            ...
            // backFontSize
            // pokerKind,
            centerTextShowed = _b.centerTextShowed, _c = _a.computedData, COUNT = _c.count, CHARS = _c.chars, 
            // backCovers: [],
            CENTER_TEXTS = _c.centerTexts, COLORS = _c.colors, IS_CENTERS = _c.isCenters;
        ...
        _this.getBackPageHtml = function () {
            ...
            // pageMarginLeft,
            // pageMarginRight,
            CARD_WIDTH = _b.pokerWidth, CARD_HEIGHT = _b.pokerHeight, _c = _a.computedData, COUNT = _c.count, 
            // chars: CHARS,
        ...
        _this.initOtherElements = function () {
            ...
            _this.configCoreElement ? .querySelectorAll('[name="pokerSizeButtons"]')
                .forEach(function (buttonElement, index) {
                if (index === 0) {
