...
// import { aboutPageMainImageVersion } from '../data/data';
...
var AboutPage = /** @class */ (function (_super) {
  ...
  function AboutPage() {
    ...
    _this.initMainElement = function () {
      ...
      var topImageElement = _this.topImageElement;
      mainElement.appendChild(topImageElement);
      topImageElement.id = "aboutPageMainImage";
      topImageElement.className = "topImage";
      topImageElement.src = "".concat(SITE_IMAGE_PATH, "7about/mainImage.jpg?")
        .concat(aboutPageMainImageVersion);
