 ...
 * <zh_tw>您想要顯示的元素。</zh_tw>
 */
export function showInlineFlex(element) {
  if (element) {
 ...
 * <zh_tw>html子元素</zh_tw>
 */
export function getElementByIdAndTagName(id, _tagName) {
  return document.getElementById(id);
}
/**
 ...
 */
export function querySelectorAllByI18n() {
 ...
 */
export function querySelectorAllByI18nPlaceholder() {
 ...
 * <zh_tw>鏈接</zh_tw>
 */
export function setAttributesOfA(aElement, link) {
 ...
 * <zh_tw>i18n數據</zh_tw>
 */
export function getI18nInnerHTML(_a) {
...
export var MONTH_NAME_ARRAY = new Array(
  "Jan",
  "Feb",
  "Mar",
  "Apr",
 ...
 * <zh_tw>日期</zh_tw>
 */
export function getI18nInnerHTMLFromDate(date) {
