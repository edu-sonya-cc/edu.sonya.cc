...
var BoxBase = (function (_super) {
  tslib_1.__extends(BoxBase, _super);
  /** OK
     * 构造方法
     */
  function BoxBase() {
    ...
    _this.appendBoxOfCuboid = function (usableBoxs) {
      ...
      [
        ...
        },
        {
          ...
          captionI18nSameSide: {
            en: "&nbsp;&nbsp;18<br/>\u00D750<br/>\u00D725<br/>+" + otherSize +
              "<br/>Rummikub",
            zh_cn: "&nbsp;&nbsp;18<br/>\u00D750<br/>\u00D725<br/>+" +
              otherSize + "<br/>\u62C9\u5BC6",
            zh_tw: "&nbsp;&nbsp;18<br/>\u00D750<br/>\u00D725<br/>+" +
              otherSize + "<br/>\u62C9\u5BC6",
          },
          otherSize: otherSize,
        },
        {
          ...
          captionI18nSameSide: {
            en: "&nbsp;&nbsp;20<br/>\u00D750<br/>\u00D728<br/>+" + otherSize +
              "<br/>Rummikub",
            zh_cn: "&nbsp;&nbsp;20<br/>\u00D750<br/>\u00D728<br/>+" +
              otherSize + "<br/>\u62C9\u5BC6",
            zh_tw: "&nbsp;&nbsp;20<br/>\u00D750<br/>\u00D728<br/>+" +
              otherSize + "<br/>\u62C9\u5BC6",
          },
          otherSize: otherSize,
        },
      ...
      [
        ...
        var captionI18n = "&nbsp;&nbsp;" + lengths[0] + "<br/>\u00D7" +
          lengths[1] + "<br/>\u00D7" + lengths[2];
