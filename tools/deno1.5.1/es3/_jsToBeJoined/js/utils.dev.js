...
System.register("utils", [], function (exports_1, context_1) {
  ...
  return {
    ...
    execute: function execute() {
      exports_1("convertDateToYYYYMMDD_hhmmss", convertDateToYYYYMMDD_hhmmss = function convertDateToYYYYMMDD_hhmmss(date) {
      ...
      exports_1("getI18nableWithSameContent", getI18nableWithSameContent = function getI18nableWithSameContent(value) {
        return {
          en_us: value,
          zh_cn: value,
          zh_tw: value
...
__exp = _instantiate("utils", false);
