...
var BrickCore = (function (_super) {
  ...
  function BrickCore() {
    ...
    _this.countDataAndComputedData = function () {
      ...
      var css =
        ...
        MAX_Y + "mm; } */\n\t\tpage { width:" + MAX_X + "mm;margin-left:" +
        pageMarginLeft + "mm;margin-top:" + pageMarginTop +
    ...
    _this.getLatticeOutSvgList = function (
      ...
      pages
        .forEach(function (page) {
          ...
          var mainWrapperCss = "width:" + SIDE_LENGTH * mainWrapperColCount +
          ...
          if (otherWrapperColCount) {
            // flex-direction:column;
            var otherWrapperCss = "width:" +
              SIDE_LENGTH * otherWrapperColCount + "mm;height:" + cssHeight +
              ";" + cssFlex;
      ...
      while (remainingColCount > 0) {
        ...
        var _loop_2 = function (i) {
          ...
          if (filterResult.length) {
            ...
            var subWrapperCss =
              "display:flex;flex-wrap:wrap;flex-direction:column;width:" +
              subWrapperWidth + "mm;height:" + subWrapperHeight + "mm;";
  ...
  BrickCore.prototype.appendSvgPath = function (
    ...
    path.setAttribute(
      ...
      ("M 0, " + RADIUS_PX)
        .concat(
          " a " + RADIUS_PX + " " + RADIUS_PX + " 0 0 1 " + RADIUS_PX + " -" +
            RADIUS_PX,
