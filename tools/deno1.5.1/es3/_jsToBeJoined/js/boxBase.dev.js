        ...
        function BoxBase() {
          ...
          _this.appendBoxOfCuboid = function (usableBoxs) {
            ...
            [{
              ...
              captionI18nSameSide: "&nbsp;&nbsp;40<br/>\xD720<br/>\xD756<br/>+" + otherSize,
              otherSize: otherSize
            }, {
              lengths: [56, 50, 80],
              ...
              captionI18nSameSide: "&nbsp;&nbsp;56<br/>\xD750<br/>\xD780<br/>+" + otherSize,
              otherSize: otherSize
            }, {
              lengths: [18, 50, 25],
              ...
              captionI18nSameSide: {
                en_us: "&nbsp;&nbsp;18<br/>\xD750<br/>\xD725<br/>+" + otherSize + "<br/>Rummikub",
                zh_cn: "&nbsp;&nbsp;18<br/>\xD750<br/>\xD725<br/>+" + otherSize + "<br/>\u62C9\u5BC6",
                zh_tw: "&nbsp;&nbsp;18<br/>\xD750<br/>\xD725<br/>+" + otherSize + "<br/>\u62C9\u5BC6"
              },
              otherSize: otherSize
            }, {
              lengths: [20, 50, 28],
              ...
              captionI18nSameSide: {
                en_us: "&nbsp;&nbsp;20<br/>\xD750<br/>\xD728<br/>+" + otherSize + "<br/>Rummikub",
                zh_cn: "&nbsp;&nbsp;20<br/>\xD750<br/>\xD728<br/>+" + otherSize + "<br/>\u62C9\u5BC6",
                zh_tw: "&nbsp;&nbsp;20<br/>\xD750<br/>\xD728<br/>+" + otherSize + "<br/>\u62C9\u5BC6"
              },
              otherSize: otherSize
            }].forEach(function (_a) {
            ...
            [10, 20, 30, 40, 50, 60, 70, 80, 90, 10].forEach(function (size) {
              infosCuboid.push({
                ...
                topWithoutHalfCircle: topWithoutHalfCircle,
                options: {},
                captionI18n: "&nbsp;&nbsp;" + size + "<br/>\xD7" + size + "<br/>\xD7" + size
              });
              infosCuboidCoverOnTheSameSide.push({
                id: '',
                boxKind: BoxKind.cuboidCoverOnTheSameSide,
                ...
                topWithoutHalfCircle: topWithoutHalfCircle,
                options: {},
                captionI18n: "&nbsp;&nbsp;" + size + "<br/>\xD7" + size + "<br/>\xD7" + size + "<br/>+" + otherSize
              });
            });
            var infosOfCuboidWithoutBottom = [];
            var infosOfCuboidCoverOnTheSameSideWithoutBottom = [];
            [[10, 10, 3], [20, 20, 8], [30, 30, 10], [40, 40, 10], [50, 50, 10], [60, 60, 10], [70, 70, 10], [80, 80, 10], [90, 90, 10]].forEach(function (lengths) {
              var captionI18n = "&nbsp;&nbsp;" + lengths[0] + "<br/>\xD7" + lengths[1] + "<br/>\xD7" + lengths[2];
            ...
            [[9, 9, 10], [19, 19, 20], [29, 29, 30], [39, 39, 40], [49, 49, 50], [59, 59, 60], [69, 69, 70], [79, 79, 80], [89, 89, 90]].forEach(function (lengths) {
              var captionI18n = "&nbsp;&nbsp;" + lengths[0] + "<br/>\xD7" + lengths[1] + "<br/>\xD7" + lengths[2];
              var otherSize = lengths[2] * 0.5;
              var captionI18nrOnTheSameSideWithoutBottom = captionI18n.concat("<br/>+" + otherSize);
...
__exp = _instantiate("boxBase", false);
