...
export abstract class DiceBase extends BrickWithTableBase {
  ...
  protected getUsableList = (): Array<object> => {
    const usableDices: Array<{
      diceFace: number;
      infos: Array<edu.sonya.cc.DiceParameter & { captionI18n: I18nable | string }>;
    }> = [];
    ...
    usableDices.forEach(
      ({
        ...
        const buttonList: Array<{ nameI18n: I18nable; info: edu.sonya.cc.DiceParameter }> = [];

        infos.forEach((info: edu.sonya.cc.DiceParameter & { captionI18n: I18nable }) => {
  ...
  private appendDiceOfSides24 = (
    ...
    infos.push({
      ...
      sideLength: 20,
      contents:
        '/i/,/ɪ/,/e/,/ɛ/,/æ/,/ɑ/,/ɑr/,/ɔ/,/ɔr/,/ɔɪ/,/o/,/u/,/ᴜ/,/ᴜr/,/ʌ/,/ə/,/ɝ/,/ɚ/,/aɪ/,/aᴜ/,/ɛr/,/ɪr/,/ɪə/,/iə/'.split(
          ',',
        ),
      outerLineStyle: 'stroke:#555;stroke-width:0.2mm;',
      innerLineStyle: 'stroke:#888;stroke-width:0.1mm;stroke-dasharray:3 2;',
    ...
    infos.push({
      ...
      sideLength: 20,
      contents:
        '/p/,/b/,/t/,/d/,/k/,/ɡ/,/f/,/v/,/θ/,/ð/,/s/,/z/,/ʃ/,/ʒ/,/tʃ/,/dʒ/,/m/,/n/,/ŋ/,/l/,/r/,/j/,/h/,/w/'.split(
          ',',
        ),
      outerLineStyle: 'stroke:#555;stroke-width:0.2mm;',
      innerLineStyle: 'stroke:#888;stroke-width:0.1mm;stroke-dasharray:3 2;',
