  ...
  (function (sonya) {
    ...
    (function (cc) {
      ...
      (function (DiceKind) {
        ...
        DiceKind[DiceKind["twentyFour"] = 32] = "twentyFour"; // 240602: add this
      ...
      })(DiceKind = cc.DiceKind || (cc.DiceKind = {})); // 240602: 8 → 9
      ...
      cc.DiceKindCount = 9; // 240602: 63 → 127
      ...
      cc.DefaultDiceKind = 127; // https://blog.csdn.net/yiyueqinghui/article/details/108004272
      ...
      function () {
        ...
        DiceGenerator.prototype.create = function (_a) {
          ...
          svg.setAttribute("height", height); // svg.setAttribute('style', `width:${width};height:${height};`);
        ...
        DiceGenerator.prototype.drawGraphsOfFourSidedDice = function (svg, SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale) {
          ...
          this.appendLine(svg, INNER_LINE_STYLE, x1, x2, y1, y2, viewBox); // 内部左下斜线
          ...
          this.appendLine(svg, INNER_LINE_STYLE, x1, x2, y1, y2, viewBox); // 内部右下斜线
          ...
          var OFFSET_Y = EXTNED_LENGTH * Math.cos(30 / 180 * Math.PI); // 外部线
        ...
        DiceGenerator.prototype.drawGraphsOfEightSidedDice = function (svg, SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale) {
          var HEIGHT_OF_ONE = SIDE_LENGTH * 1.732 * 0.5;
          var HEIGHT_OF_TWO = HEIGHT_OF_ONE * 2;
          var BOTTOM = HEIGHT_OF_ONE * 3; // 内部横线

          this.appendLine(svg, INNER_LINE_STYLE, 0, SIDE_LENGTH * 2, HEIGHT_OF_ONE, HEIGHT_OF_ONE, null);
          this.appendLine(svg, INNER_LINE_STYLE, SIDE_LENGTH * 0.5, SIDE_LENGTH * 2.5, HEIGHT_OF_TWO, HEIGHT_OF_TWO, null); // 内部左下斜线
          ...
          this.appendLine(svg, INNER_LINE_STYLE, SIDE_LENGTH * 3, SIDE_LENGTH * 2, HEIGHT_OF_ONE, BOTTOM, null); // 内部右下斜线
        ...
        DiceGenerator.prototype.drawGraphsOfTenSidedDice = function (svg, SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale) {
          ...
          var PASTE_SCALE = SIDE_LENGTH < 3 ? 1 : SIDE_LENGTH <= 10 ? 0.5 : 0.25;
        ...
        DiceGenerator.prototype.drawGraphsOfTwelveSidedDice = function (svg, SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale) {
          ...
          var SECOND_GROUP_OFFSET = SIDE_LENGTH * 2 + LONG_SIDE_LENGTH + SIN18_MULTIPLY_SIDE_LENGTH;
          var TOP = SIN72_MULTIPLY_QUARTER_SIDE_LENGTH;

          for (var groupIndex = 0; groupIndex < 2; ++groupIndex) {
            var LEFT = (groupIndex === 0 ? 0 : SECOND_GROUP_OFFSET) + SIN72_MULTIPLY_QUARTER_SIDE_LENGTH;
            var A1x = 0,
                A1y = 0;
            var A2x = 0,
                A2y = 0;
            ...
            var LINE_STYLE = groupIndex === 0 ? INNER_LINE_STYLE : OUTER_LINE_STYLE;
            ...
            var F8x = 0,
                F8y = 0;
            var F9x = 0,
                F9y = 0; // const SIN18_MULTIPLY_QUARTER_SIDE_LENGTH = QUARTER_SIDE_LENGTH * SIN18;
            ...
            if (groupIndex === 0) {
              ...
              C9y = C2y - SIN36_MULTIPLY_QUARTER_SIDE_LENGTH; // 无D6和D7
        ...
        DiceGenerator.prototype.drawGraphsOfTwentyFourSidedDice = function (svg, SIDE_LENGTH, INNER_LINE_STYLE, OUTER_LINE_STYLE, viewBox, OPTIONS, mmToPxScale) {
          ...
          var OFFSET_X = -23.0805019730301175; // 080501973030115 1.7763568394002505e-14mm
          // 08050197303012 -1.0658141036401503e-14mm

          var X_VALUE = 150; // const ax1 = 150, ay1 = 0;
        ...
        DiceGenerator.prototype.appendText = function (svg, STYLE, CONTENT, x, y, rotate, viewBox) {
          ...
          var g = document.createElementNS(SVG_NS, "g"); // g.setAttribute('x', `${x}mm`);
          ...
          text.setAttribute("style", "dominant-baseline:middle;text-anchor:middle;"); // text.setAttribute('dx', '0');
          ...
          if (CONTENT.indexOf("<") > -1) {
            ...
            CONTENT.split("").forEach(function (_char, index) {
              _this.appendTspan(text, "", _char, 0, 0, 0);
            });
          }
...
})(edu || (edu = {})); // export default edu.sonya.cc;