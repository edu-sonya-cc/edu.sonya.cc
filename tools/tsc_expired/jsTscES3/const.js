...
exports.REPORT_KIND_PROPERTY = exports.PAPER_SIZE_PROPERTY = exports
  .ID_PROPERTY = exports.REPORT_PROPERTY = exports.DEVICE_PROPERTY = exports
    .PAGE_PROPERTY = exports.LANG_PROPERTY = exports.SUB_KIND_NAME_PROPERTY =
      exports.ACTIVATED_PROPERTY = exports.BRICK_SUB_KINDS = exports
        .MORE_BUTTON_HTML = exports.PAGE_ID = exports.PAGE_IDNEX = exports
          .PAGE_SUB_KIND = exports.getPageParameterByName = exports
            .SITE_CSS_PATH = exports.SITE_JAVASCRIPT_PATH = exports
              .SITE_IMAGE_PATH = exports.SITE_ROOT = exports.ACTUAL_PAGE_NAME =
                exports.ACTUAL_PAGE_VALUE = exports.PARAMETER_FOR_ACTUAL_PAGE =
                  exports.getActualPageValueByName = exports.getActualPageName =
                    exports.ACTUAL_PAGE_NAME_ARRAY = exports.ActualPage =
                      exports.HOME_URL_LENGTH = exports.HOME_URL = exports
                        .CURRENT_URL = exports.FILENAME_POSTFIX = exports
                          .DOMAIN = void 0;
/**
 * <en>Domain</en>
 * <zh_cn>网站域名</zh_cn>
...
exports.getActualPageName = getActualPageName;
/**
...
exports.getActualPageValueByName = getActualPageValueByName;
/**
 ...
 */
exports.ACTUAL_PAGE_VALUE = exports.CURRENT_URL.indexOf(
    "?".concat(exports.PARAMETER_FOR_ACTUAL_PAGE, "="),
  ) > -1
  ? (0, exports.getActualPageValueByName)(
    exports.CURRENT_URL.split("?")[1].split("&")[0].split("=")[1],
  )
  : ActualPage.home;
/**
 ...
 * <zh_tw>當前實際頁面名</zh_tw>
 */
exports.ACTUAL_PAGE_NAME =
  exports.ACTUAL_PAGE_NAME_ARRAY[exports.ACTUAL_PAGE_VALUE];
/**
 * <en>Site Root</en>
 * <zh_cn>网站根目录</zh_cn>
 * <zh_tw>網站根目錄</zh_tw>
 */
exports.SITE_ROOT = exports.HOME_URL.substring(
  0,
  exports.HOME_URL.lastIndexOf("/") + 1,
);
/**
 ...
 * <zh_tw>網站圖片目錄</zh_tw>
 */
exports.SITE_IMAGE_PATH = "".concat(exports.SITE_ROOT, "images/");
/**
 * <en>Site Script Directory</en>
 * <zh_cn>网站脚本目录</zh_cn>
 * <zh_tw>網站腳本目錄</zh_tw>
 */
exports.SITE_JAVASCRIPT_PATH = "".concat(exports.SITE_ROOT, "js/");
/**
 * <en>Site Style Sheet Directory</en>
 * <zh_cn>网站样式表目录</zh_cn>
 * <zh_tw>網站樣式表目錄</zh_tw>
 */
exports.SITE_CSS_PATH = "".concat(exports.SITE_ROOT, "css/");
/**
...
var getPageParameterByName = function (name, defaultValue) {
  return exports.CURRENT_URL.indexOf("&".concat(name, "=")) === -1
    ? defaultValue || ""
    : exports.CURRENT_URL.split("&").slice(1).filter(function (keyValue) {
      return keyValue.startsWith("".concat(name, "="));
    })[0].split("=")[1];
};
exports.getPageParameterByName = getPageParameterByName;
/**
 * <en>Sub kind of current page</en>
 * <zh_cn>页面子类型</zh_cn>
 * <zh_tw>頁面子類型</zh_tw>
 */
exports.PAGE_SUB_KIND = (0, exports.getPageParameterByName)("kind", null);
/**
 * <en>Page Index</en>
 * <zh_cn>页序</zh_cn>
 * <zh_tw>頁序</zh_tw>
 */
exports.PAGE_IDNEX =
  parseInt((0, exports.getPageParameterByName)("page", "1"), 0) - 1;
/**
 * <en>Page parameter: No</en>
 * <zh_cn>页面参数：编号</zh_cn>
 * <zh_tw>頁面參數：編號</zh_tw>
 */
exports.PAGE_ID = parseInt((0, exports.getPageParameterByName)("id", "1"), 0);
/**
 * <en>“查看更多”按钮文字</en>
 * <zh_cn>View more button text</zh_cn>
 * <zh_tw>“查看更多”按鈕文字</zh_tw>
 */
exports.MORE_BUTTON_HTML =
