...
var PokerBase = /** @class */ (function (_super) {
    ...
    function PokerBase(appendData, otherComputedData) {
        ...
        _this.countDataAndComputedData = function () {
            var _a = _this.data, paperSize = _a.paperSize, isLandscape = _a.isLandscape, MAX_X = _a.maxX, MAX_Y = _a.maxY, pokerWidth = _a.pokerWidth, pokerHeight = _a.pokerHeight, pageMarginTop = _a.pageMarginTop, 
            // pageMarginBottom,
            pageMarginLeft = _a.pageMarginLeft, 
            // pageMarginRight,
            CARD_WIDTH = _a.pokerWidth, CARD_HEIGHT = _a.pokerHeight, fontSize = _a.fontSize, backFontSize = _a.backFontSize, pokerKind = _a.pokerKind;
