      ...
      sectionList.forEach(function (_a, sectionIndex) {
        ...
        switch (sectionClass) {
          case "leftAndRightSidesTextAndImage":
            ...
            var imageUrlInTextAndImage = "".concat(SITE_IMAGE_PATH, "1home/")
              .concat(image);
          ...
          case "leftAndRightSidesList":
            ...
            var leftAreaOfLeftAndRightSidesListWrapElement = createElement(
              "div",
            );
            ...
            var _loop_1 = function (i) {
              ...
              var _b = storiesOfFirstPage[i],
                id_1 = _b.id,
                date = _b.date,
                title_1 = _b.title,
                summary_1 = _b.summary;
          ...
          case "flippableCardList":
            ...
            var TEACHER_IMAGE_POSTFIX_1 = "".concat(
              SITE_IMAGE_PATH,
              "1home/teachers/",
            );
            for (var i = 0; i < TEACHER_COUNT_PER_PAGE; ++i) {
              ...
              var name_1 = createElement("span");
              name_1.className = "homePageTeacherName";
              wrap.appendChild(name_1);
            ...
            rightArrowElement_1.setAttribute(
              "id",
              "flippableCardListRightArrow",
            );
            var teacherCount = teachers.length;
            var teacherPageCount = Math.ceil(
            ...
            function gotoPage(pageIndex) {
              ...
              for (var i = 0; i < teacherCountOfCurrentPage; ++i) {
                var aElement = flippableCardsElement_1.children[i];
                var teacher = teachers[indexOffset + i];
                var name_2 = teacher.name,
                  link = teacher.link,
                  i18n = teacher.i18n;
                ...
                var imageUrl = "".concat(TEACHER_IMAGE_POSTFIX_1).concat(
                  name_2,
                  ".png",
                );
                ...
                var urlElement = wrap.children[2].children[0];
                urlElement.innerHTML = link;
              }
              for (
                var i = TEACHER_COUNT_PER_PAGE - teacherCountOfCurrentPage;
                i > 0;
                --i
              ) {
                var aElement =
                  flippableCardsElement_1.children[TEACHER_COUNT_PER_PAGE - i];
