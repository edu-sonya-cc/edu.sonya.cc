...
class HomePage extends ActualPageBase {
  constructor() {
    ...
    this.TEACHER_COUNT_PER_PAGE = PageSize.homePage.teachers;
    this.sectionList = [
      {
        id: "homePageAbout",
...
依此因緣，略集巨匠之作，管中窺豹，可見重器一斑。`,
    ...
    this.initMainElement = () => {
      ...
      sectionList.forEach(
        (
          { id, "class": sectionClass, title, summary, image, items, moreLink },
          sectionIndex,
        ) => {
          ...
          switch (sectionClass) {
            case "leftAndRightSidesTextAndImage":
              ...
              summaryElementInTextAndImage.innerHTML = getI18nInnerHTML(
                summary,
              );
            ...
            case "leftAndRightSidesList":
              ...
              for (let i = 0; i < storiesPageSize; ++i) {
                ...
                storyTitleAndTimeElement.className =
                  "homePageStoryTitleAndTime";
            ...
            case "flippableCardList":
              ...
              rightArrowElement.setAttribute(
                "id",
              ...
              function gotoPage(pageIndex) {
                ...
                const teacherCountOfCurrentPage =
                  pageIndex < maxTeacherPageIndex
                ...
                for (
                  ...
                  const aElement =
                    flippableCardsElement.children[TEACHER_COUNT_PER_PAGE - i];
