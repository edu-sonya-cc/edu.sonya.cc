...
var BrickBase = (function () {
    function BrickBase(appendData, otherComputedData, newPageSizeArray) {
        ...
        // public sponsor = (): void => { };
        this.build = function () {
            var _a = _this.data, paperSize = _a.paperSize, isLandscape = _a.isLandscape, maxX = _a.maxX, maxY = _a.maxY, pageMarginTop = _a.pageMarginTop, pageMarginBottom = _a.pageMarginBottom, pageMarginLeft = _a.pageMarginLeft, pageMarginRight = _a.pageMarginRight;
            ...
            getElementById("brickPageIframe").contentWindow
                ? .postMessage({
            ...
            var _b = _this, getHtml = _b.getHtml, getCss = _b.getCss;
            var html = getHtml();
            var css = getCss();
        ...
        this.data = tslib_1.__assign({}, this.data, appendData);
        this.DEFAULT_DATA_JSON = JSON.stringify(this.data);
        this.computedData = tslib_1.__assign({}, this.computedData, otherComputedData);
