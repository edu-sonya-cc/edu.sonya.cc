...
class BrickWithTableBase extends BrickBase {
  constructor(appendData, otherComputedData) {
    super(
      Object.assign({ list: [] }, appendData),
      Object.assign({}, otherComputedData),
    );
    this.initCoreElementsBeforeTable = () => {};
    this.initCoreElementsAfterTable = () => {};
    this.tableWrapElement = createElement("div");
    this.tableElement = createElement("table");
    this.tableHeadElement = createElement("thead");
    this.tableBodyElement = createElement("tbody");
    this.trHead = createElement("tr");
    this.trArray = [];
    this.idOrClassPrefix = "brickPage";
    ...
    this.appendTableHeadCell = (i18n) => {
      const { trHead } = this;
      const td = createElement("td");
      trHead.appendChild(td);
      td.innerHTML = getI18nInnerHTML(i18n);
    };
    this.appendReadonlyTd = (tr, innerHTML) => {
      const td = createElement("td");
      tr.appendChild(td);
      const span = createElement("span");
      td.appendChild(span);
    ...
    this.appendTextboxTd = (tr, value, data, fieldName) => {
      const td = createElement("td");
      tr.appendChild(td);
    ...
    this.appendCheckboxTdWithoutText = (tr, value, data, fieldName) => {
      const td = createElement("td");
      tr.appendChild(td);
    ...
    this.appendNumberTd = (tr, value, data, fieldName, min, max, step) => {
      const td = createElement("td");
      tr.appendChild(td);
      const input = createElement("input");
      input.type = "number";
    ...
    this.appendSelectTd = (tr, value, data, fieldName, options) => {
      const td = createElement("td");
      tr.appendChild(td);
    ...
    this.appendOperationTd = (tr, data) => {
      const td = createElement("td");
      tr.appendChild(td);
