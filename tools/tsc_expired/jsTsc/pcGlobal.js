  ...
  function PcGlobal() {
    ...
    this.onAddFavorite = function (event) {
      ...
      switch (ACTUAL_PAGE_NAME) {
        ...
        case "brick":
        case "story":
          url = HOME_URL + "?go=" + ACTUAL_PAGE_NAME + "&kind=" +
            _this.getPageSubKind();
          break;
        case "treasures":
        case "stories":
          url = HOME_URL + "?go=" + ACTUAL_PAGE_NAME + "&kind=" +
        ...
        case "bricks":
          url = HOME_URL + "?go=" + ACTUAL_PAGE_NAME + "&kind=" +
            _this.getPageSubKind() + "&page=" + _this.getPageIndex();
          break;
        default:
          break;
      }
    ...
    this.onShare = function (event) {
      ...
      var wechatShareImageSrc = "" + SITE_IMAGE_PATH + ACTUAL_PAGE_NAME +
        wechatShareImageSrcPostfix + ".png";
    ...
    this.onChangeLanuage = function (event) {
      ...
      setCurrentLang(
        getElementById("topMenuLanguage")
          .value,
      );
      return stopEventBubble(event);
    };
