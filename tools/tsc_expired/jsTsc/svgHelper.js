        ...
        var SvgHelper = (function () {
          ...
          SvgHelper.appendText = function (
            ...
            if (rotate) {
              g.setAttribute(
                "style",
                "transform: rotate(" + rotate + "deg);transform-origin:" +
                  transformOrigin + ";",
              );
            }
            svg.appendChild(g);
          ...
          SvgHelper.getTextStyleFontSizePatchCss = function (
            ...
            if (NUMBER > 99 && TEXT_STYLE.indexOf("font-size:") > -1) {
              ...
              return "font-size:" + fontValue * 2 / NUMBER.toString().length +
                fontUnit + ";";
            }
            return "";
          };
...
exports["default"] = svgSpace.edu.sonya.cc;
