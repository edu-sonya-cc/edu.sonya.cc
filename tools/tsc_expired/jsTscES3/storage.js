...
exports.clearChangeLangNotifyArrayOfCurrentPage = exports
  .getChangeLangNotifyArrayOfCurrentPage = exports.setCurrentPageLocalStorage =
    exports.getCurrentPageLocalStorage = exports.updateUIByCurrentLang = exports
      .setCurrentLang = exports.getCurrentLang = exports
        .LOCAL_STORAGE_KEY_OF_CURRENT_PAGE = exports.LOCAL_STORAGE_KEY_OF_LANG =
          void 0;
...
var getCurrentLang = function () {
  return (localStorage.getItem(exports.LOCAL_STORAGE_KEY_OF_LANG) || "zh_cn");
};
...
var setCurrentLang = function (lang) {
  ...
  (0, exports.updateUIByCurrentLang)();
};
...
var updateUIByCurrentLang = function () {
  var lang = (0, exports.getCurrentLang)();
...
exports.updateUIByCurrentLang = updateUIByCurrentLang;
/**
...
exports.getCurrentPageLocalStorage = getCurrentPageLocalStorage;
/**
...
var setCurrentPageLocalStorage = function (newValue) {
  return localStorage.setItem(
    exports.LOCAL_STORAGE_KEY_OF_CURRENT_PAGE,
    newValue,
  );
};
exports.setCurrentPageLocalStorage = setCurrentPageLocalStorage;
/**
...
exports.getChangeLangNotifyArrayOfCurrentPage =
