...
var BrickCore = (function (_super) {
  ...
  function BrickCore() {
      ...
      for (var a = 0; a <= 100; ++a) {
        ...
        _this.plusOrSubtractDictionaryNotGreatThan100Array.push({
          ...
          subtractorWithDebitMinusMaxIndex:
            subtractorWithDebitMinusArray.length -
            1,
      ...
      ["1-5", "0-5", "0-10", "0-20"].forEach(function (scope) {
        ...
        for (var a = min; a <= max; ++a) {
          ...
          for (var b = min; b <= bMax; ++b) {
            ...
            var answer = "<p>" + commonHtml + '<answer chars="2">' + result +
              "</answer></p>";
            list.push({
              question: question,
      ...
      ["9×9A", "9×9B"].forEach(function (scope) {
        ...
        for (var a = 1; a < 10; ++a) {
          for (var b = bStartFrom1 ? 1 : a; b < 10; ++b) {
            var result = a * b;
            var commonHtml = (a + " \u00D7 " + b + " = ").replace(
              / /g,
              "<i> </i>",
            );
            var question = "<p>" + commonHtml + "</p>";
            var answer = "<p>" + commonHtml + (result < 10 ? " " : "") +
              result + "</p>";
            list.push({
              question: question,
              questionFull: question,
    ...
    _this.countDataAndComputedData = function () {
      ...
      computedData.css =
        ...
        MAX_X + "mm;margin-left:" + pageMarginLeft + "mm;margin-top:" +
        pageMarginTop + "mm; }\npage { height:" + MAX_Y +
      ...
      var i18nSubtitle = {
        en: '<span class="subtitleDay">' + day +
          '</span> <span class="subtitleMonth">' + month +
          '</span>, <span class="subtitleYear">' + year + "</span>",
        zh_cn: '<span class="subtitleYear">' + year +
          '</span>\u5E74<span class="subtitleMonth">' + month +
          '</span>\u6708<span class="subtitleDay">' + day + "</span>\u65E5",
        zh_tw: '<span class="subtitleYear">' + year +
          '</span>\u5E74<span class="subtitleMonth">' + month +
          '</span>\u6708<span class="subtitleDay">' + day + "</span>\u65E5",
      };
      // const i18nCopies = {
      ...
      var HTML_SUBTITLE = '<div class="subtitle">' + i18nSubtitle[LANG] +
        "</div>";
      var titlePostfix =
        ("_" + NOW.getFullYear() +
      ...
      var zh_cn = FILENAME_POSTFIX +
        "\u6570\u5B66\u4E94\u5206\u949F\u95EF\u5173_" + titlePostfix;
      var zh_tw = FILENAME_POSTFIX +
        "\u6578\u5B78\u4E94\u5206\u9418\u95D6\u95DC_" + titlePostfix;
      ...
      var questionPageStartHtml = '<page class="questionPage">' +
        questionPageSubjectRowHtml;
      var answerPageStartHtml = '<page class="answerPage">' +
    ...
    _this.getSimleHtmlOfAMultiplyB = function (A, B, result) {
      return "<p><number>" + A +
        "</number></p><p><operator>\u00D7</operator><number>" + B +
        "</number></p><hr><p><number>" + result + "</number></p>";
    };
    ...
    _this.fillElementArrayOfAPlusBThenC = function (
      ...
      var commonHtml = withBrackets
        ? C + "<i> </i>+<i> </i>(" + A + "<i> </i>+<i> </i>" + B +
          ")<i> </i>=<i> </i>"
        : A + "<i> </i>+<i> </i>" + B + "<i> </i>+<i> </i>" + C +
          "<i> </i>=<i> </i>";
      var questionElementHtml = "<p>" + commonHtml + "</p>" +
        questionElementHtmlAppend; // .replace(/~charCount~/g, charsStr)
      ...
      if (!onlyMentalArithmetic) {
        ...
        var tensCarryHtml = tensCarry
          ? '<carry edu-digit="tens">' +
            Math.floor((aDidits + bDidits + cDidits) / 10) + "</carry>"
          : "";
        ...
        answerElementHtml += "<p></p><p><number>" + A +
          "</number></p><p><operator>+</operator><number>" + B + "</number>" +
          hundredsCarryHtml1 + tensCarryHtml1 + "</p><hr><p><number>" + A_B +
          "</number></p>";
        answerElementHtml += '<hr class="step"/><p></p>';
        answerElementHtml += "<p></p><p><number>" + A_B +
          "</number></p><p><operator>+</operator><number>" + C + "</number>" +
          hundredsCarryHtml2 + tensCarryHtml2 + "</p><hr><p><number>" + result +
          "</number></p>";
        answerElementHtml += "</answer-option>";
        answerElementHtml += '<answer-option edu-chars="' + charsStr +
          '"><p></p><p></p>';
        answerElementHtml += "<p><number>" + A +
          "</number></p><p><operator>+</operator><number>" + B + "</number>" +
          hundredsCarryHtml1 + tensCarryHtml1 + "</p><hr><p><number>" + A_B +
          "</number></p>";
        answerElementHtml += "<p><operator>+</operator><number>" + C +
          "</number>" + hundredsCarryHtml2 + tensCarryHtml2 +
          "</p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
        answerElementHtml += '<answer-option edu-chars="' + charsStr +
          '"><p></p><p></p><p></p><p>';
        answerElementHtml += "<number>" + A + "</number></p><p><number>" + B +
          "</number></p>";
        answerElementHtml += "<p><operator>+</operator><number>" + C +
          "</number>" + hundredsCarryHtml + tensCarryHtml +
          "</p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
    ...
    _this.fillElementArrayOfASubtractBThenC = function (
      ...
      if (withBrackets) {
        ...
        (_c = _this.getMaybeCarryTwiceNumbers(has),
          a = _c.a,
          b = _c.b,
          c = _c.c,
          d = _c.d);
      ...
      var commonHtml = withBrackets
        ...
        : A + "<i> </i>-<i> </i>" + B + "<i> </i>-<i> </i>" + C +
          "<i> </i>=<i> </i>";
      var questionElementHtml = "<p>" + commonHtml + "</p>" +
        questionElementHtmlAppend; // .replace(/8/g, charsStr)
      var answerElementHtml = "<p>" + commonHtml + result + "</p>";
      if (onlyMentalArithmetic) {
        _this.fillElementListCore(
          questionElementHtml,
      ...
      function doneBPlusCAndThenASubstractIt() {
        ...
        answerElementHtml += debitHtml + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + bPlusC +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
      }
      function doneASubstractCSubstractB() {
        ...
        answerElementHtml += '<answer-option edu-chars="' + charsStr + '">';
        answerElementHtml += debitHtmlStep1 + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + C +
          "</number></p><hr>";
        answerElementHtml += debitHtmlStep2 + "<p><number>" + aSubstractC +
          "</number></p><p><operator>-</operator><number>" + B +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
      }
      function doneASubstractBSubstractC() {
        ...
        answerElementHtml += debitHtmlStep1 + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + C +
          "</number></p><hr>";
        answerElementHtml += debitHtmlStep2 + "<p><number>" + aSubstractB +
          "</number></p><p><operator>-</operator><number>" + B +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
      }
      if (withBrackets) {
        ...
        answerElementHtml += '<answer-option edu-chars="' + charsStr + '">';
        answerElementHtml += debitHtml1 + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + B +
          "</number></p><hr><p><number>" + aSubstractB + "</number></p>";
        answerElementHtml += '<hr class="step"/>';
        answerElementHtml += debitHtml2 + "<p><number>" + aSubstractB +
          "</number></p><p><operator>-</operator><number>" + C +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
        var htmlSubstractTwice = "".concat(
          '<answer-option edu-chars="' + charsStr + '">',
          debitHtml1 + "<p><number>" + A +
            "</number></p><p><operator>-</operator><number>" + B +
            "</number></p><hr>",
          debitHtml2 + "<p><number>" + aSubstractB +
            "</number></p><p><operator>-</operator><number>" + C +
            "</number></p><hr><p><number>" + result + "</number></p>",
          "</answer-option>",
        );
    ...
    _this.fillElementArrayOfASubtractBThenPlusC = function (
      ...
      function doneAPlusCSubstractB() {
        ...
        answerElementHtml += "<p><number>" + A +
          "</number></p><p><operator>+</operator><number>" + C + "</number>" +
          hundredsCarryHtml + tensCarryHtml + "</p><hr>";
        answerElementHtml += debitHtmlAPlusCSubstractB + "<p><number>" +
          aPlusC + "</number></p><p><operator>-</operator><number>" + B +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
      }
      if (withBrackets) {
        ...
        answerElementHtml += '<answer-option edu-chars="' + charsStr + '">';
        answerElementHtml += debitHtmlStep1 + "<p><number>" + B +
          "</number></p><p><operator>-</operator><number>" + C +
          "</number></p><hr><p><number>" + bSubstractC + "</number></p>";
        answerElementHtml += '<hr class="step"/><p></p>';
        answerElementHtml += debitHtmlStep2 + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + bSubstractC +
          "</number></p><hr><p><number>" + result + "</number></p>";
        answerElementHtml += "</answer-option>";
        if (bDigits !== cDigits) {
          if (A >= B && aDigits === bDigits) {
            ...
            answerElementHtml += '<answer-option edu-chars="' + charsStr + '">';
            answerElementHtml += debitHtmlASubstractB + "<p><number>" + A +
              "</number></p><p><operator>-</operator><number>" + B +
              "</number></p><hr><p><number>" + aSubstractB + "</number></p>";
        ...
        // 算法2：两式合并
        var debitExtendHtmlASubstractB = getDebitHtml(A, B) + "<p><number>" +
          A + "</number></p><p><operator>-</operator><number>" + B +
          "</number></p><hr>";
        ...
        if (bDigits === cDigits && aDigits !== cDigits) {
          ...
          answerElementHtml += '<answer-option edu-chars="' + charsStr +
            '"><p></p><p></p>';
          answerElementHtml += debitHtml + "<p><number>" + B +
            "</number></p><p><operator>-</operator><number>" + C +
            "</number></p><hr>";
    ...
    _this.fillElementArrayOfAPlusBThenSubtractC = function (
      ...
      function doneASubstractCPlusB() {
        ...
        answerElementHtml += debitHtml + "<p><number>" + A +
          "</number></p><p><operator>-</operator><number>" + C +
          "</number></p><hr>";
        answerElementHtml += "<p><number>" + AC +
          "</number></p><p><operator>+</operator><number>" + B + "</number>" +
          hundredsCarryHtml + tensCarryHtml + "</p><hr><p><number>" + result +
          "</number></p>";
        answerElementHtml += "</answer-option>";
      }
      function doneAPlusBSubstractC(twoOption) {
        ...
        if (twoOption) {
          ...
          answerElementHtml += '<hr class="step"/><p></p>';
          answerElementHtml += debitHtmlABSubstractC + "<p><number>" + AB +
            "</number></p><p><operator>-</operator><number>" + C +
            "</number></p><hr><p><number>" + result + "</number></p>";
          answerElementHtml += "</answer-option>";
        }
      ...
      function doneBSubstractCThenPlusA(twoOption) {
        ...
        if (twoOption) {
          ...
          answerElementHtml += debitHtml + "<p><number>" + B +
            "</number></p><p><operator>-</operator><number>" + C +
            "</number></p><hr><p><number>" + BC + "</number></p>";
          answerElementHtml += '<hr class="step"/><p></p>';
          answerElementHtml += "<p><number>" + BC +
            "</number></p><p><operator>+</operator><number>" + A + "</number>" +
            hundredsCarryHtml + tensCarryHtml + "</p><hr><p><number>" + result +
            "</number></p>";
          answerElementHtml += "</answer-option>";
        }
  ...
  BrickCore.prototype.fillElementArrayOfAPlusB = function (
    ...
    if (!onlyMentalArithmetic) {
      var charsStr = (result.toString().length + 1).toString();
      answerElementHtml += this.questionElementHtmlAppendStart4 +
        '<answer-option edu-chars="' + charsStr + '"><p></p>' +
        getHtmlOfAPlusB(A, B, result) + "</answer-option></div>";
    }
  ...
  BrickCore.prototype.getHtmlOfAMultiplyB = function (A, B, result) {
    ...
    for (var i = 0; i < resultLength; ++i) {
      ...
      if (carryNumber > 0) {
        // <carry edu-digit="tens">1</carry>
        html += '<carry edu-digit="' + eduDigitArray[resultLength - 2 - i] +
          '">' + carryNumber + "</carry>";
      }
    }
    html += "</p>";
  ...
  BrickCore.prototype.fillElementArrayOfASubtractB = function (
    ...
    var result = A - B;
    var commonHtml = A + " - " + B + " = ";
    var questionElementHtml = "<p>" + commonHtml.replace(/ /g, "<i> </i>") +
      "</p>" + questionElementHtmlAppend; // .replace(/4/g, charsStr)
    var answerElementHtml = "<p>" + commonHtml.replace(/ /g, "<i> </i>") +
      result + "</p>";
    if (!onlyMentalArithmetic) {
      var debitHtml = getDebitHtml(A, B);
      answerElementHtml += this.questionElementHtmlAppendStart4 +
        '<answer-option edu-chars="' + charsStr + '">' + debitHtml +
        "<p><number>" + A + "</number></p><p><operator>-</operator><number>" +
        B + "</number></p><hr><p><number>" + result +
  ...
  BrickCore.prototype.getDebitHtml = function (A, B) {
    ...
    var digitDebitHtml = tensNeedDebit
      ? '<debit edu-digit="digit"><debit-number>' + (10 + aDigits) +
        "</debit-number></debit>"
      : "";
    var tensDebitHtml = tensNeedDebit || hundredsNeedDebit
      ? '<debit edu-digit="tens"><debit-number>' + ((hundredsNeedDebit
        ? 10
        : 0) +
        Math.floor(aHundreds / 10) -
        (tensNeedDebit ? 1 : 0)) +
        "</debit-number>" + (tensNeedDebit
          ? "<debit-circle>·</debit-circle>"
          : "") +
        "</debit>"
      : "";
    var hundredsDebitHtml = hundredsNeedDebit
      ...
      : "";
    // return debitHtml;
    return '<p class="debit">&nbsp;' + hundredsDebitHtml + tensDebitHtml +
      digitDebitHtml + "</p>";
  };
  BrickCore.prototype.getDebitHtmlOfASubstractB = function (A, B, aSubstractB) {
    return this.getDebitHtml(A, B) + "<p><number>" + A +
      "</number></p><p><operator>-</operator><number>" + B +
      "</number></p><hr><p><number>" + aSubstractB + "</number></p>";
  };
  /** OK
  ...
  BrickCore.prototype.countByArithmetic1 = function (
    ...
    for (var rowIndex = 0; rowIndex < rows; ++rowIndex) {
      ...
      for (
        var questionIndex = 0; questionIndex < countPerRow; ++questionIndex
      ) {
        var has = mustHasnot
          ? false
  ...
  BrickCore.prototype.countByArithmetic8Or9 = function (
    ...
    var questionRows = [];
    var answerRows = [];
    var _b = this.exhaustibleAMultiplyBInfo,
      aMultiplyBMaybeCarryArray = _b.aMultiplyBMaybeCarryArray,
      aMultiplyBMaybeNotCarryArray = _b.aMultiplyBMaybeNotCarryArray,
      aMultiplyBMaybeDebitMinusArray = _b.aMultiplyBMaybeDebitMinusArray,
      aMultiplyBMaybeNotDebitMinusArray = _b.aMultiplyBMaybeNotDebitMinusArray,
      aMultiplyBMaybeCarryMaxIndex = _b.aMultiplyBMaybeCarryMaxIndex,
      aMultiplyBMaybeNotCarryMaxIndex = _b.aMultiplyBMaybeNotCarryMaxIndex,
      aMultiplyBMaybeDebitMinusMaxIndex = _b.aMultiplyBMaybeDebitMinusMaxIndex,
      aMultiplyBMaybeNotDebitMinusMaxIndex =
        _b.aMultiplyBMaybeNotDebitMinusMaxIndex;
    // 0-100A/0-100B/0-100C分别表示无进位加、必定有进位加、不确定是否有进位加
    var mustHasnot = scope === "0-100A";
    var mustHas = scope === "0-100B";
    var maybeHas = scope === "0-100C";
    for (var rowIndex = 0; rowIndex < rows; ++rowIndex) {
      ...
      for (
        ...
        var commonHtml = switchOrder
          ? "<i> </i>" + C + "<i> </i>" + operator + "<i> </i>" + A +
            "<i> </i>\u00D7<i> </i>" + B + "<i> </i>=<i> </i>"
          : A + "<i> </i>\u00D7<i> </i>" + B + "<i> </i>" + operator +
            "<i> </i>" + C + "<i> </i>=<i> </i>";
        var questionElementHtml = "<p>" + commonHtml + "</p>" +
          questionElementHtmlAppend;
        var answerElementHtml = "<p>" + commonHtml + result + "</p>";
    ...
    for (var rowIndex = 0; rowIndex < rows; ++rowIndex) {
      ...
      for (
        ...
        var charsStr = ((isPlus
          ...
          .toString();
        var commonHtml = A + "<i> </i>\u00D7<i> </i>(" + B + "<i> </i>" +
          (isPlus ? "+" : "-") + "<i> </i>" + C + ")<i> </i>=<i> </i>";
        var questionElementHtml = "<p>" + commonHtml + "</p>" +
          questionElementHtmlAppend;
        var answerElementHtml = "<p" + fontSizeCss + ">" + commonHtml + result +
          "</p>";
        if (!onlyMentalArithmetic) {
          ...
          if (A < 10) {
            answerElementHtml += "<p><operator>\u00D7</operator><number>" + A +
              "</number></p><hr><p><number>" + result + "</number></p>";
          } else {
            answerElementHtml += '<hr class="step"/>';
            answerElementHtml += this.getHtmlOfAMultiplyB(B_C, A, result);
  ...
  BrickCore.prototype.countByArithmetic11 = function (
    ...
    for (var rowIndex = 0; rowIndex < rows; ++rowIndex) {
      ...
      for (
        ...
        answerElementHtml = "<p>" + html.replace(/ /g, "<i> </i>") +
