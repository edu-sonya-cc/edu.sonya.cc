  ...
  function BrickCore() {
    ...
    _this.countDataAndComputedData = function () {
      ...
      var css =
        ...
        pageMarginLeft + "mm;margin-top:" + pageMarginTop + "mm; }\n\t\t";
      var html = "";
      var NUMBER_MIN = 1;
        ...
        pages.forEach(function (PAGE_COUNT, numberIndex) {
          ...
          for (var pageIndex = 0; pageIndex < PAGE_COUNT; ++pageIndex) {
            ...
            var startNumberOffset = digitalOverlay
              ...
              : 0;
            for (
              var rowIndex = 0; rowIndex < VERTICAL_RODS_ROW_COUNT; ++rowIndex
            ) {
              for (
                var colIndex = 0; colIndex < VERTICAL_RODS_COL_COUNT; ++colIndex
              ) {
            ...
            for (
              var rowIndex = 0; rowIndex < HORIZONTAL_RODS_ROW_COUNT; ++rowIndex
            ) {
              for (
                var colIndex = 0;
