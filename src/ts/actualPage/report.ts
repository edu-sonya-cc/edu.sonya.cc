...
class ReportPage extends ActualPageBase {
  private styleElement = createElement("style") as HTMLStyleElement;
  private reportElement = createElement("div") as HTMLDivElement;
  private titleElement = getTitleElement();
  private paperSize = "A4";
  private isLandscape = false;
  private pageMarginTop = 0;
  private pageMarginLeft = 0;
  private pageMarginBottom = 0;
  ...
  public updateReport(title: I18nable, css: string, html: string) {
    const { styleElement, reportElement, titleElement } = this;

    styleElement.innerHTML = css;
    reportElement.innerHTML = html;

    (titleElement as { i18n: I18nable }).i18n = title;
