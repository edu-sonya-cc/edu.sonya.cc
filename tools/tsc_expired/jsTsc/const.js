 ...
 */
exports.ACTUAL_PAGE_VALUE =
  exports.CURRENT_URL.indexOf(
      "?".concat(exports.PARAMETER_FOR_ACTUAL_PAGE, "="),
    ) > -1
    ? exports.getActualPageValueByName(
 ...
 * <zh_tw>頁序</zh_tw>
 */
exports.PAGE_IDNEX = parseInt(exports.getPageParameterByName("page", "1"), 0) -
  1;
/**
